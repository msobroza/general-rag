...
def remove_multilingual_stopwords(text):
    """Remove stopwords from text using French stopwords list.
...
def get_language_docs(documents):
    ...
    return AB_LANG[detect(all_text)]
